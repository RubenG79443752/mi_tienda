...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>AGRE</b>CONST</span>
    </a>
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
        ...
        <li><a href="https://wa.link/kqm7tm"><i class="fa fa-question-circle"></i><span>Consultas 79443752</span><small class="label pull-right bg-yellow">WHATSAAP</small></a></li>
